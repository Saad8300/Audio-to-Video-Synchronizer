...
# Now, we need to pass text_overlay_config to each generator
# For generate_video
...
# For generate_video_timeline and generate_media_timeline
# They also end with progress_callback=update_progress\n            )
# Oh wait, my previous replacement will hit all of them!
# Let's verify by just printing the count of occurrences.
